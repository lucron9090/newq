  ...
  <q-responsive :ratio="16 / 9" class="col">
    <div>
      <div class="q-pa-md q-gutter-sm">
        ...
        <TaskStatus :isLoading="isLoading" :isGenerating="isGenerating" :taskStatus="taskStatus" :error="error"
          :responseStatus="generatorStatus" :progress="progress" />
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      isGenerating: false,
      error: null,
      generatorStatus: null, finishedImage: null,
      intervalId: null,
      taskStatus: null,
      ...
      this.intervalId = setInterval(async () => {
        if (this.loopcounter >= 15) {
          ...
          try {
            ...
            if(data.folder_name) {
              this.finishedImage = 'https://oldie.veriftools.ru/media/generator_item/' + data.folder_name + '/result_image.jpg';
            }
            if (data) {
              ...
              if (this.taskStatus === 'end') {
                ...
                this.generatorStatus = data.response_status;
                this.finishedImage = 'https://oldie.veriftools.ru/media/generator_item/' + data.folder_name + '/result_image.jpg';
          ...
          this.taskStatus = this.finishedImage;
